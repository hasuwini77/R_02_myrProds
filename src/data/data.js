...
export const MYR_TRACKS = [ 
    ...
    new Song("bretagne.jpg", "MYR", "Bretagne Time", "Track inspired by the beauty of Bretagne in France, inspired by the dope Artist Kristoffer Eikrem with his amazong sound pack, it's a really smooth track, well produced and very chill, enjoy!", "BretagneTime.mp3", "chill"),
    new Song("aurore.jpg", "MYR", "Aurore", "This track is a collaboration with the Norwegian Artist and Jazzman Kristoffer Eikrem, it is by far my most successful track though it is definitely not my favourite one. It was a dream to collaborate with Kristoffer, since I'm a big fan of his work. The track is very jazzy, very viby, it's a vibe! I hope we can work again soon! Enjoy it! ", "Aurore.mp3", "jazzy"),
